...
-- Dump completed on 2015-03-23 19:19:19
...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `fk_table1_users` FOREIGN KEY (`commentfrom`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_table1_users1` FOREIGN KEY (`users_user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
